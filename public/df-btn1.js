...
const config = {
	...
	usuario: wrapper.getAttribute('usuario'),
	...
	gateway: wrapper.getAttribute('gateway')
}

if (!config.project){
    console.warn('Debe especificar el codigo de proyecto abilitado!')
}
    ...
    document.write(`
        <button class="df-btn df-closed" onclick="dfToggle()">
            ...
            <iframe class="df-btn-content" src=${'http://localhost:5500/#/directo?usuario='+config.usuario}></iframe>
        </button>
    `)
