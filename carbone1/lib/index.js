...
var carbone = {
  ...
  //////////////////////////////////////////////// mio ///////////////////////////////
  render_datos: function (templatePath, callback)  {
	 //tool1.findMarkers(templatePath, function (err, template) {
	var datos_var = []	 
	var _files = [templatePath];
    walkReports(_files, 0, "", function (a,datos) {
...
function walkReports (reports, currentIndex, strToFind, callback) {
  if (currentIndex >= reports.length) {
    ...
    return callback(null,datos_var)
  }
